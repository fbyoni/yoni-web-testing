...
class HeaderComponent extends Component {
  ...
  #resizeObserver = new ResizeObserver(([entry]) => {
    ...
    (document.body.style.setProperty("--header-height", `${height}px`),
      this.#menuDrawerHiddenWidth &&
        ...
        this.#updateMenuVisibility(!1));
  });
  #observeStickyPosition = (alwaysSticky = !0) => {
  ...
  #handleWindowScroll = () => {
    ...
    const scrollTop = document.scrollingElement?.scrollTop ?? 0,
      isScrollingUp = scrollTop < this.#lastScrollTop;
    if (
      ...
      ? (this.removeAttribute("data-animating"),
        this.getBoundingClientRect().top >= 0
          ? ((this.#offscreen = !1),
            ...
            (this.dataset.scrollDirection = "none"))
          : ((this.dataset.stickyState = "active"), (this.dataset.scrollDirection = "up")))
      : this.dataset.stickyState === "active"
        ? ((this.dataset.scrollDirection = "none"),
          this.setAttribute("data-animating", ""),
          (this.#timeout = setTimeout(() => {
            ((this.dataset.stickyState = "idle"), this.removeAttribute("data-animating"));
          }, this.#animationDelay)))
        : ((this.dataset.scrollDirection = "none"), (this.dataset.stickyState = "idle")),
      (this.#lastScrollTop = scrollTop));
  };
  connectedCallback() {
    ...
    stickyMode &&
      ...
      (stickyMode === "scroll-up" || stickyMode === "always") &&
  ...
  onDocumentLoaded(() => {
    ...
    if (headerGroup) {
      const resizeObserver = new ResizeObserver(() =>
        ...
        children = headerGroup.children;
      for (let i = 0; i < children.length; i++) {
        const element = children[i];
        element === header || !(element instanceof HTMLElement) || resizeObserver.observe(element);
      }
      new MutationObserver((mutations) => {
        for (const mutation of mutations)
          if (mutation.type === "childList") {
            const children2 = headerGroup.children;
      ...
      }).observe(headerGroup, { childList: !0 });
    }
  }));
//# sourceMappingURL=/cdn/shop/t/3/assets/header.js.map?v=78043468934677320351754421400
