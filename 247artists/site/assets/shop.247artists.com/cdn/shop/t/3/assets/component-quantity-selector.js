...
class QuantitySelectorComponent extends Component {
  increaseQuantity(event) {
    event.target instanceof HTMLElement &&
      (event.preventDefault(), this.refs.quantityInput.stepUp(), this.#onQuantityChange());
  }
  decreaseQuantity(event) {
    event.target instanceof HTMLElement &&
      (event.preventDefault(), this.refs.quantityInput.stepDown(), this.#onQuantityChange());
  }
...
//# sourceMappingURL=/cdn/shop/t/3/assets/component-quantity-selector.js.map?v=56330027151833116691754421401
