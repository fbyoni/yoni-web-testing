...
export class QuickAddComponent extends Component {
  ...
  #openQuickAddModal = () => {
    ...
    dialogComponent instanceof QuickAddDialog &&
      (this.#stayVisibleUntilDialogCloses(dialogComponent), dialogComponent.showDialog());
  };
  #closeQuickAddModal = () => {
    const dialogComponent = document.getElementById("quick-add-dialog");
    ...
    if (!(!productGrid || !modalContent)) {
      if (isMobileBreakpoint()) {
        ...
        const productFormComponent = productGrid.querySelector("product-form-component"),
          ...
          productPrice = productGrid.querySelector("product-price"),
          productTitle = document.createElement("a");
        if (
          ((productTitle.textContent = this.dataset.productTitle || ""),
          (productTitle.href = this.productPageUrl),
          !productFormComponent || !variantPicker || !productPrice || !productTitle)
        )
          return;
      ...
      (morph(modalContent, productGrid), this.#syncVariantSelection(modalContent));
    }
  }
  #syncVariantSelection(modalContent) {
    ...
    for (const input of modalInputs)
      if (
        ...
        ((input.checked = !0), input.dispatchEvent(new Event("change", { bubbles: !0 })));
        break;
      }
  }
}
...
//# sourceMappingURL=/cdn/shop/t/3/assets/quick-add.js.map?v=74531385036627369001754935554
