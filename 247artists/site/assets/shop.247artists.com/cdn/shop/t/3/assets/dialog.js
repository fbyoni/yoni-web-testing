...
export class DialogComponent extends Component {
  ...
  connectedCallback() {
    (super.connectedCallback(),
      (this.minWidth || this.maxWidth) && window.addEventListener("resize", this.#handleResize));
  }
  disconnectedCallback() {
    (super.disconnectedCallback(),
      (this.minWidth || this.maxWidth) && window.removeEventListener("resize", this.#handleResize));
  }
...
document.addEventListener(
  ...
  (event) => {
    if (
      (event.target instanceof HTMLDialogElement || event.target instanceof HTMLDetailsElement) &&
...
//# sourceMappingURL=/cdn/shop/t/3/assets/dialog.js.map?v=94382931671780430451754421400
