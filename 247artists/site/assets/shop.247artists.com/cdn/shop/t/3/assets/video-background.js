...
export class VideoBackgroundComponent extends Component {
  ...
  connectedCallback() {
    ...
    for (const source of videoSources) {
      ...
      videoSource && source.setAttribute("src", videoSource);
    }
    videoElement.load();
  }
}
customElements.get("video-background-component") ||
  customElements.define("video-background-component", VideoBackgroundComponent);
//# sourceMappingURL=/cdn/shop/t/3/assets/video-background.js.map?v=25237992823806706551754421400
