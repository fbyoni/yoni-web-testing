class ThemePerformance {
  ...
  measureFromEvent(benchmarkName, event) {
    const metricName = `${this.metricPrefix}:${benchmarkName}`,
      startMarker = performance.mark(`${metricName}:start`, { startTime: event.timeStamp });
...
//# sourceMappingURL=/cdn/shop/t/3/assets/performance.js.map?v=25067702614201670671754421400
