...
class ProductInventory extends HTMLElement {
  ...
  updateInventory = (event) => {
    ...
    newInventory && morph(this, newInventory, { childrenOnly: !0 });
  };
}
customElements.get("product-inventory") ||
  customElements.define("product-inventory", ProductInventory);
//# sourceMappingURL=/cdn/shop/t/3/assets/product-inventory.js.map?v=16343734458933704981754421400
