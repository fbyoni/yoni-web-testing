    ...
    const refs = {},
      elements = this.roots.reduce((acc, root) => {
        for (const element of root.querySelectorAll("[ref]"))
          this.#isDescendant(element) && acc.add(element);
        return acc;
      }, new Set());
...
function getClosestComponent(node) {
  ...
  if (
    ...
    (node instanceof HTMLElement && node.tagName.toLowerCase().endsWith("-component"))
  )
    return node;
...
//# sourceMappingURL=/cdn/shop/t/3/assets/component.js.map?v=110735723013117678201754935551
