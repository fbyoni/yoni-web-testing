class ProductRecommendations extends HTMLElement {
  ...
  connectedCallback() {
    (this.#intersectionObserver.observe(this),
      this.#mutationObserver.observe(this, { attributes: !0 }));
  }
  #loadRecommendations() {
  ...
  async #fetchCachedRecommendations(productId, sectionId, intent) {
    const url = `${this.dataset.url}&product_id=${productId}&section_id=${sectionId}&intent=${intent}`,
      cachedResponse = this.#cachedRecommendations[url];
    ...
    try {
      ...
      return ((this.#cachedRecommendations[url] = text), { success: !0, data: text });
    } finally {
...
//# sourceMappingURL=/cdn/shop/t/3/assets/product-recommendations.js.map?v=100985322374402248581754421401
