...
class ProductPrice extends HTMLElement {
  connectedCallback() {
    ...
    closestSection && closestSection.addEventListener(ThemeEvents.variantUpdate, this.updatePrice);
  }
  ...
  updatePrice = (event) => {
    ...
    !newPrice ||
      !currentPrice ||
      (currentPrice.innerHTML !== newPrice.innerHTML && currentPrice.replaceWith(newPrice));
  };
}
customElements.get("product-price") || customElements.define("product-price", ProductPrice);
//# sourceMappingURL=/cdn/shop/t/3/assets/product-price.js.map?v=30079423257668675401754421400
