...
export class MediaGallery extends Component {
  ...
  #handleVariantUpdate = (event) => {
    ...
    newMediaGallery && this.replaceWith(newMediaGallery);
  };
  #handleZoomMediaSelected = async (event) => {
    this.slideshow?.select(event.detail.index, void 0, { animate: !1 });
  };
  zoom(index, event) {
...
//# sourceMappingURL=/cdn/shop/t/3/assets/media-gallery.js.map?v=111441960308641931071754421400
