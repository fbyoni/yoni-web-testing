...
export default class ResultsList extends PaginatedList {
  ...
  updateLayout({ target }) {
    target instanceof HTMLInputElement && this.#animateLayoutChange(target.value);
  }
  ...
  #setLayout(value) {
    const { grid } = this.refs;
    grid && grid.setAttribute("product-grid-view", value);
  }
  #handleMediaQueryChange = (event) => {
    ...
    targetElement instanceof HTMLInputElement &&
      ((targetElement.checked = !0), this.#setLayout("default"));
  };
}
customElements.get("results-list") || customElements.define("results-list", ResultsList);
//# sourceMappingURL=/cdn/shop/t/3/assets/results-list.js.map?v=28346210841421047511754421401
