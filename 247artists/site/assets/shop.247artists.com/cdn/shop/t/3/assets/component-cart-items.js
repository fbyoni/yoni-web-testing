    ...
    (cartTotal?.shimmer(),
      fetch(`${Theme.routes.cart_change_url}`, fetchConfig("json", { body }))
        ...
        .then((responseText) => {
          ...
          if ((resetShimmer(this), parsedResponseText.errors)) {
        ...
        .finally(() => {
          (this.#enableCartItems(), cartPerformance.measureFromMarker(cartPerformaceUpdateMarker));
        }));
  }
...
//# sourceMappingURL=/cdn/shop/t/3/assets/component-cart-items.js.map?v=95720873921622680421754421400
