...
export class FloatingPanelComponent extends HTMLElement {
  #updatePosition = async () => {
    ...
    if (((this.style.top = OFFSET + "px"), rect.right > viewportWidth)) {
  ...
  #resizeListener = debounce(() => {
    const parent = this.closest("details"),
      closeOnResize = this.dataset.closeOnResize === "true";
    parent instanceof HTMLDetailsElement &&
      closeOnResize &&
      ((parent.open = !1), parent.removeAttribute("open"), this.#updatePosition());
  }, 100);
  connectedCallback() {
    (window.addEventListener("resize", this.#resizeListener),
      requestIdleCallback(() => {
        (this.#updatePosition(), this.#mutationObserver.observe(this, { attributes: !0 }));
      }));
  }
...
customElements.get("floating-panel-component") ||
  customElements.define("floating-panel-component", FloatingPanelComponent);
//# sourceMappingURL=/cdn/shop/t/3/assets/floating-panel.js.map?v=128677600744947036551754421400
