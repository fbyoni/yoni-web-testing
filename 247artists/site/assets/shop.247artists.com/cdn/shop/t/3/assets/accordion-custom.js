...
class AccordionCustom extends HTMLElement {
  ...
  #handleKeyDown(event) {
    event.key === "Escape" &&
      ...
      (event.preventDefault(), (this.details.open = !1), this.summary.focus());
  }
}
customElements.get("accordion-custom") ||
  customElements.define("accordion-custom", AccordionCustom);
//# sourceMappingURL=/cdn/shop/t/3/assets/accordion-custom.js.map?v=99000499017714805851754421400
