...
export class VariantSelectedEvent extends Event {
  constructor(resource) {
    (super(ThemeEvents.variantSelected, { bubbles: !0 }), (this.detail = { resource }));
  }
}
export class VariantUpdateEvent extends Event {
  constructor(resource, sourceId, data) {
    (super(ThemeEvents.variantUpdate, { bubbles: !0 }),
      (this.detail = {
...
export class CartAddEvent extends Event {
  constructor(resource, sourceId, data) {
    (super(CartAddEvent.eventName, { bubbles: !0 }),
...
export class CartUpdateEvent extends Event {
  constructor(resource, sourceId, data) {
    (super(ThemeEvents.cartUpdate, { bubbles: !0 }),
      (this.detail = { resource, sourceId, data: { ...data } }));
  }
}
export class CartErrorEvent extends Event {
  constructor(sourceId, message) {
    (super(ThemeEvents.cartError, { bubbles: !0 }),
      (this.detail = { sourceId, data: { message } }));
  }
}
export class QuantitySelectorUpdateEvent extends Event {
  constructor(quantity, cartLine) {
    (super(ThemeEvents.quantitySelectorUpdate, { bubbles: !0 }),
      (this.detail = { quantity, cartLine }));
  }
}
export class DiscountUpdateEvent extends Event {
  constructor(resource, sourceId) {
    (super(ThemeEvents.discountUpdate, { bubbles: !0 }), (this.detail = { resource, sourceId }));
  }
}
export class MediaStartedPlayingEvent extends Event {
  constructor(resource) {
    (super(ThemeEvents.mediaStartedPlaying, { bubbles: !0 }), (this.detail = { resource }));
  }
}
export class SlideshowSelectEvent extends Event {
  constructor(data) {
    (super(SlideshowSelectEvent.eventName, { bubbles: !0 }), (this.detail = data));
  }
  detail;
...
export class ZoomMediaSelectedEvent extends Event {
  constructor(index) {
    (super(ThemeEvents.zoomMediaSelected, { bubbles: !0 }), (this.detail = { index }));
  }
}
export class MegaMenuHoverEvent extends Event {
  constructor() {
    super(ThemeEvents.megaMenuHover, { bubbles: !0 });
  }
}
export class FilterUpdateEvent extends Event {
  constructor(queryParams) {
    (super(ThemeEvents.FilterUpdate, { bubbles: !0 }), (this.detail = { queryParams }));
  }
  shouldShowClearAll() {
    return (
...
//# sourceMappingURL=/cdn/shop/t/3/assets/events.js.map?v=26166644030623418901754421400
