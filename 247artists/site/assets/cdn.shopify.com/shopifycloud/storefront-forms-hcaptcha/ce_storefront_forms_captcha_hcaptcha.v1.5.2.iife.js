!(function () {
  ...
  const n = "password",
    e = "form_key",
    s = ["recaptcha-v3-token", "g-recaptcha-response", "h-captcha-response", n],
    a = () => {
      try {
                ...
                new Promise((n, e) => {
                  ...
                  ((s.src = t),
                    ...
                    (s.onerror = (t) => {
                      var n;
                      const s = new Error(
                        `The captcha provider script ${(null == (n = null == t ? void 0 : t.target) ? void 0 : n.src) || ""} didn't load correctly.`,
                      );
                      e(s);
                    }),
    ...
    r = (t) => console.error("form submit failed", t);
  const h = "shop-hcaptcha-badge-container";
  function l(t) {
  ...
  function d(t, n, e, s) {
    return p("a", { href: n, target: "_blank", textContent: e, className: s }, p("li", {}, t));
  }
  const f = "h-captcha",
    u = "data-hcaptcha-bound";
  function m(i, h, l, p = !1) {
    if (!i || i.getAttribute(u)) return;
    if (!h || !h.execute) throw new Error("hcaptcha is required");
    if (!l) throw new Error("siteKey is required");
    const d = (function (t, n) {
      ...
      y = (function (t, n) {
        ...
        h.execute(v, { async: !0 }).then(({ response: r }) => {
          const h = "h-captcha-response";
          (i.elements[h] ||
            i.append(Object.assign(document.createElement("input"), { type: "hidden", name: h })),
            (i.elements[h].value = r),
            p &&
              (function (i) {
                try {
                  if (!a()) return;
                  ...
                  (!(function (t, n) {
                    (c(t) ||
                      t.append(
                        Object.assign(document.createElement("input"), { type: "hidden", name: e }),
                      ),
                      (t.elements[e].value = n));
                  })(i, r),
                    (function (t, e) {
                      const c = a();
                      if (!c) return;
                      const i = [...t.querySelectorAll(`input[type='${n}']`)].map(
                          ({ name: t }) => t,
                        ),
                        r = [...s, ...i],
                        h = {};
                      for (const [n, s] of new FormData(t).entries()) r.includes(n) || (h[n] = s);
                      c.setItem(e, JSON.stringify({ [o]: 1, action: t.action, data: h }));
                    })(i, r));
                } catch (r) {
                  console.error("failed to persist form", r);
                }
              })(i));
        }),
      );
      ...
      return (async function () {
        ...
        .then((a) => {
          (m(t, a, n, e),
            s &&
              (function (t) {
                if (l("p[data-spam-detection-disclaimer]") || l(`#${h}`)) return;
  ...
  ((window.Shopify = window.Shopify || {}),
    ...
    (window.Shopify.ce_forms.bindForm = v),
    window.Shopify.ce_forms.q &&
      (window.Shopify.ce_forms.q.forEach(([t, n]) =>
        v(...t).then(() => "function" == typeof n && n()),
      ),
