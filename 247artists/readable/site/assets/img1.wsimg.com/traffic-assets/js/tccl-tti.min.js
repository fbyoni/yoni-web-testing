  ...
  return (
    (n = [
      ...
      function (t, e, n) {
        "use strict";
        ((e.__esModule = !0),
          (e.setCustomProperties =
            e._sendWebVitalsData =
            e._collectVitals =
            e.calculateTTI =
              void 0),
          n(2));
        function i() {
          0 < s.timeToInteractive &&
            setTimeout(function () {
              ((window._expDataLayer = window._expDataLayer || []),
                window._expDataLayer.push({
                  ...
                  data: window._tccInternal
                    ? { type: "pageperf", properties: s, custom_properties: c }
                    : { timing_object: s, is_hard_navigation: !0, custom_properties: c },
                }));
            }, 0);
        }
        function r() {
          var t,
            e,
            n = (r = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}).name,
            r = r.value;
          ((s[n] = "CLS" === n ? r : Math.round(r)),
            "timeToInteractive" === n &&
              (s.hasOwnProperty("FID")
                ? i()
                : ((t = 0),
                  (e = setInterval(function () {
                    ((s.hasOwnProperty("FID") || 10 < t) &&
                      (e && (clearInterval(e), (e = null)), i()),
                      (t += 1));
                  }, 500)))));
        }
        var o = n(5),
        ...
        ((e.calculateTTI = function () {
          ...
          try {
            ((0, u.getLCP)(e, !0),
              (0, u.getFID)(e),
              (0, u.getCLS)(e, !0),
              (0, o.getFirstConsistentlyInteractive)().then(function (t) {
                e({ name: "timeToInteractive", value: t });
              }));
          } catch (t) {
            (0, a.error)('unable to calculate "web-vitals" performance metrics', t);
          }
        }),
          (e._collectVitals = r),
      ...
      function (t, e, n) {
        ...
        ((rt = n(4)),
          ...
          (t.exports = (function () {
            ...
            else if (f === undefined && "function" === "function") S = T();
            else S = w();
            function E(t, e) {
              var n = this;
              var r = new this.constructor(j);
              if (r[x] === undefined) X(r);
              var i = n._state;
              if (i) {
                var o = arguments[i - 1];
                u(function () {
            ...
            function I(e, t) {
              if (t._state === P) B(e, t._result);
              else if (t._state === O) W(e, t._result);
              else
                H(
                  t,
                  undefined,
            ...
            function B(t, e) {
              if (t._state !== A) return;
              t._result = e;
              t._state = P;
              if (t._subscribers.length !== 0) u(R, t);
            }
            function W(t, e) {
              if (t._state !== A) return;
              t._state = O;
            ...
            var z = (function () {
              function t(t, e) {
                ...
                if (!this.promise[x]) X(this.promise);
                if (n(e)) {
                  this.length = e.length;
                  this._remaining = e.length;
                  this._result = new Array(this.length);
                  if (this.length === 0) B(this.promise, this._result);
                  else {
                    this.length = this.length || 0;
                    this._enumerate(e);
                    if (this._remaining === 0) B(this.promise, this._result);
                  }
                } else W(this.promise, J());
              }
              ...
              t.prototype._eachEntry = function t(e, n) {
                ...
                if (i === L) {
                  ...
                  if (o === E && e._state !== A) this._settledAt(e._state, n, e._result);
              ...
              t.prototype._settledAt = function t(e, n, r) {
                ...
                if (this._remaining === 0) B(i, this._result);
              };
            ...
            function Q(i) {
              ...
              if (!n(i))
                ...
                return new o(function (t, e) {
                  var n = i.length;
                  for (var r = 0; r < n; r++) o.resolve(i[r]).then(t, e);
                });
            }
            function Z(t) {
              var e = this;
      ...
      function (y, g, t) {
        ...
        ((w = t(0)),
          (function () {
            var r =
                ("undefined" == typeof window || window !== this) && void 0 !== w && null != w
                  ? w
                  : this,
              e =
                  ...
                  (("childList" == (e = e.value).type &&
                    (function t(e, n) {
                      for (var r = (e = l(e)).next(); !r.done; r = e.next())
                        if (
                          ((r = r.value), n.includes(r.nodeName.toLowerCase()) || t(r.children, n))
                        )
                          return 1;
                    })(e.addedNodes, a)) ||
                    ("attributes" == e.type && a.includes(e.target.tagName.toLowerCase()))) &&
                    n(e);
              });
              return (
                t.observe(document, {
                ...
                ((r = this).c = new PerformanceObserver(function (t) {
                  for (var e, n = (t = l(t.getEntries())).next(); !n.done; n = t.next())
                    ("resource" === (n = n.value).entryType &&
                      (r.b.push({ start: n.fetchStart, end: n.responseEnd }),
                      m(r, h(r.g, r.b) + 5e3)),
                  ...
                  var t = performance.timing.navigationStart,
                    ...
                    n =
                      ...
                      (performance.timing.domContentLoadedEventEnd
                        ? (n = performance.timing).domContentLoadedEventEnd - n.navigationStart
                        : null),
                    r = performance.now();
      ...
      function (t, e, n) {
        ...
        function c(t, e) {
          return {
            ...
            id: "v2-"
              .concat(Date.now(), "-")
              .concat(1e12 + Math.floor(8999999999999 * Math.random())),
          };
        }
        function f(t, e) {
          try {
        ...
        function a(t, e) {
          v || ((v = e), (h = t), (u = new Date()), L(removeEventListener), E());
        }
        function o(t) {
          var e, n, r, i;
          function o() {
          ...
          t.cancelable &&
            ((e = (1e12 < t.timeStamp ? new Date() : performance.now()) - t.timeStamp),
            "pointerdown" == t.type
              ? ((n = e),
                (r = t),
                (i = function () {
                ...
                addEventListener("pointercancel", u, T))
              : a(e, t));
        }
        var v,
          h,
          ...
          _ = function (e, t) {
            ...
            function r(t) {
              ...
              t.hadRecentInput ||
                ((e = a[0]),
                (n = a[a.length - 1]),
                u && t.startTime - n.startTime < 1e3 && t.startTime - e.startTime < 5e3
                  ? ((u += t.value), a.push(t))
                  : ((u = t.value), (a = [t])),
                u > o.value && ((o.value = u), (o.entries = a), i()));
            }
            var i,
              o = c("CLS", 0),
              u = 0,
          ...
          x = function (t, e) {
            function n(t) {
              t.startTime < r.firstHiddenTime &&
                ((i.value = t.processingStart - t.startTime), i.entries.push(t), u(!0));
            }
            var r = s(),
              i = c("FID"),
              o = f("first-input", n),
          ...
          A = function (e, n) {
            function t(t) {
              var e = t.startTime;
              e < o.firstHiddenTime && ((u.value = e), u.entries.push(t), r());
            }
            var r,
              i,
              o = s(),
              u = c("LCP"),
              a = f("largest-contentful-paint", t);
            a &&
              ((r = p(e, u, n)),
              (i = function () {
                j[u.id] || (a.takeRecords().map(t), a.disconnect(), (j[u.id] = !0), r(!0));
              }),
              ...
              d(function (t) {
                ((u = c("LCP")),
                  ...
                  requestAnimationFrame(function () {
                    requestAnimationFrame(function () {
                      ((u.value = performance.now() - t.timeStamp), (j[u.id] = !0), r(!0));
                    });
                  }));
              }));
          },
        ...
        var i,
          ...
          a =
            ...
            "undefined" == typeof window
              ? { window: u, document: o, navigator: n }
              : { window: window || u, document: window.document || o, navigator: navigator || n });
        e.getWindow = r;
      },
      function (t, e, n) {
        "use strict";
        ...
        t.exports = {
          ...
          removeUndefined: function t(e) {
            for (var n in e)
              void 0 === e[n]
                ? delete e[n]
                : "object" === i(e[n]) && (t(e[n]), 0 === Object.keys(e[n]).length && delete e[n]);
          },
        };
      },
    ]),
