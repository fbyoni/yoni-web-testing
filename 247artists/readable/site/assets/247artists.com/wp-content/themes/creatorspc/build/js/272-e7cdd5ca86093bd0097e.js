    ...
    272: (t, e, s) => {
      ...
      window.plr.controllers.SiteScrollbar = class extends i.c {
        ...
        dragMove(t) {
          ...
          t.preventDefault();
          const e =
              ((t.clientY || (t.touches && t.touches[0].clientY)) - this.dragStartY) /
              window.safeHeight,
            s = (this.dragStartScroll + e) * window.maxScrollTop;
          luge.smoothscroll.lenis ? luge.smoothscroll.lenis.scrollTo(s) : window.scrollTo(0, s);
        }
        dragEnd(t) {
          (t.preventDefault(), (this.dragging = !1), this.el.classList.remove("is-dragging"));
        }
      };
    },
  },
