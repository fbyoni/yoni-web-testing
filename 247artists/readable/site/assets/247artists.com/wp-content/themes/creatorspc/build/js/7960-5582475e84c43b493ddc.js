  ...
  [7960],
  {
    7960: (t, e, i) => {
      ...
      (n.w$.registerPlugin(h.c, o.c),
        (window.plr.controllers.STestimonialsHome = class extends s.c {
          init() {
            (super.init(),
          ...
          onResize() {
            (this.setSizes(), this.setLines(), this.initScroll());
          }
          onViewportIn() {
            this.isPaused = !1;
          }
          ...
          setSizes() {
            ...
            ((this.bounding = this.el.getBoundingClientRect()),
              (this.render = { width: this.bounding.width, height: this.bounding.height }),
              (t.style.width = `${this.render.width}px`),
              (t.style.height = `${this.render.height}px`));
          }
          setLines() {
            const { wrapper: t, testimonial: e } = this.refs,
              { bounding: i, lineSpacing: s, lineWidth: n, render: h } = this,
              o = s + n;
            this.blocks = [];
            ...
            (e.forEach((t, e) => {
              const i = t.getBoundingClientRect(),
                s = i.top - (a ? a.bottom : r.top),
                n = l,
                h = l + s;
              (this.blocks.push({ start: n, end: h }), (l += s + i.height), (a = i));
            }),
              this.blocks.push({ start: l, end: r.bottom - i.top }),
              (this.lines = []),
              this.blocks.forEach((t) => {
                const e = t.end - t.start;
                for (let i = o; i < e - o; i += o) {
                  const e = [],
                    s = { x: h.width, y: t.start + i },
                    n = { x: s.x - h.width * (0.15 + 0.7 * Math.random()), y: s.y };
                  (e.push(s),
                    e.push(n),
                    this.lines.push({
                      points: e,
          ...
          initScroll() {
            ...
            (this.tl && this.tl.revert(),
              ...
              this.tl.fromTo(
                this.lines,
                { p: 0.25 },
                { p: 1, duration: 3, ease: "power3.inOut", stagger: { each: 0.075 } },
                2,
              ));
          }
          drawLines(t) {
