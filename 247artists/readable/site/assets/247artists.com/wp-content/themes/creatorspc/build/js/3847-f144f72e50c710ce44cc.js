  ...
  [3847],
  {
    3847: (t, i, e) => {
      ...
      (h.w$.registerPlugin(n.c, r.c),
        (window.plr.controllers.Error404 = class extends s.c {
          init() {
            super.init();
          ...
          setRects() {
            ...
            const e = i.getBoundingClientRect(),
              ...
              r = s.top - e.top + s.height / 2 - 5,
              o = r + 10;
            ((this.innerRect = {
              p1: { x: (s.left + s.right) / 2, y: r },
              p2: { x: (s.left + s.right) / 2, y: r },
              p3: { x: (s.left + s.right) / 2, y: o },
              p4: { x: (s.left + s.right) / 2, y: o },
              offset: 0,
            }),
